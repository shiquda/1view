...
import { Card, Typography, Button, Spin, Result, Alert, Tooltip } from 'antd';
import { SyncOutlined, InfoCircleOutlined, WarningOutlined } from '@ant-design/icons';
      ...
      {loading ? (
        ...
        <div style={{ width: '100%' }}>
          ...
          <div style={{ marginTop: 16, display: 'flex', justifyContent: 'center' }}>
            <Tooltip title="CORS 错误可能是由浏览器安全限制导致的">
              {error.includes('CORS') && (
                <Alert
                  type="warning"
                  showIcon
